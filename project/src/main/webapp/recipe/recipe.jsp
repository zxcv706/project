...
<link rel="stylesheet" href="${contextPath}/css/food.css">
</head>
...
<body>
	...
	<div id="Recipe1_wrap">
		...
		<div id="Recipe1_header">
			...
			<!-- Home -->
			<div id="logo">
				<a id="ssadagoo_logo" href="${contextPath}/">SSADAGOO</a>
			</div>

			<!-- 카테고리명 -->
			<div id="Recipe1_categoryname">${foodCate}</div>
				...
				<c:forEach items="${foods}" var="food">
					<div id="Recipe1_center_menu">
						<div id="Recipe1_center_menu_img1">
							<a href="${food.url}"> <img
								src="${contextPath}/img/food/${foodFolder}/${food.foodImg}" />
							</a>
						</div>
		...
		<div id="Recipe_pagination">
			<div class="container w-100 mx-auto">
				<ul class="pagination justify-content-center" style="margin: 20px 0">
					...
					<li class="page-item"><a class="page-link" href="/project/recipe/foods?foodCate=${foodCate}&page=1">1</a></li>
					<li class="page-item active"><a class="page-link" href="/project/recipe/foods?foodCate=${foodCate}&page=2">2</a></li>
					<li class="page-item"><a class="page-link" href="/project/recipe/foods?foodCate=${foodCate}&page=3">3</a></li>
